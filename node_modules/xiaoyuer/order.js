...
exports.get_order_list = (function(){
    ...
    *获取发布需求订单
    ...
    return {
        ...
        wservice1:get_welfare_ser_order1,
        wservice2:get_welfare_ser_order2,
        wrequire1:get_welfare_req_order1,
        wrequire2:get_welfare_req_order2,
        game1:get_order_game1,
        game2:get_order_game2
    }
})();
